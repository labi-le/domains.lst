...
| `pbr` | `/etc/init.d/pbr` | Regenerates rule-provider files, writes `99-tproxy.nft`, populates nft set `tproxy_ip4`, then restarts Mihomo | static |
...
| `mihomo` | fallback health | `https://platform.claude.com/` | Probe URL for `VPN-PREFERRED` |
